...
const { arrayPDApi } = require('../lib/arrayPDAPI.js');
const { makeURL } = require('../lib/makePDAPI.js');

async function getPDAPI(sku, targetsite) {
...
module.exports.getPDAPI = getPDAPI;