...
function task(site, mode) {    
    main(site, mode).then((data) => {
        ...
        fs.writeFileSync('../outputs/' + site + '_' + mode +slicedFileName+'_PD_output.json',result);
...
function readSearchAPI(site,mode){    
    ...
    const searchAPI = JSON.parse(fs.readFileSync("C:\\Users\\1\\Documents\\SMB\\S28_1200-master\\S28_1300\\input\\Search_API_"+site+'.json'));      
