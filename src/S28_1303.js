...
async function main(site){
    ...
    fs.writeFileSync('../outputs/' + site +'_tieredData.json',output);
...
async function returnTieredList(site){    
    ...
    let arr = new Array();
    const Search_API = JSON.parse(fs.readFileSync("Y:/smb/2024smb/sit/data/"+getDate.getCurrentDate()+"/Search_API_Result/Search_API_"+site+'.json'));            
